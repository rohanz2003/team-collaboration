          ...
          <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                <path d="M7.657 1.04c.207-.528 1.071-.528 1.278 0l1.152 2.94a.25.25 0 0 0 .158.158l2.94 1.152c.528.207.528 1.071 0 1.278l-2.94 1.152a.25.25 0 0 0-.158.158l-1.152 2.94c-.207.528-1.071.528-1.278 0l-1.152-2.94a.25.25 0 0 0-.158-.158l-2.94-1.152c-.528-.207-.528-1.071 0-1.278l2.94-1.152a.25.25 0 0 0 .158-.158L7.657 1.04Z"/>
              </svg>
            </button>
            <button
