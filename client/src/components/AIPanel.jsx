    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 600, color: '#0d1117' }}>AI Assistant</span>
        </div>
        <button
          onClick={onClose}
          style={{
            ...
            color: '#656d76', lineHeight: 1, fontSize: 12,
          }}
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid #d0d7de' }}>
        ...
        {tab === 'chat' && (
          <>
            {conversation.length === 0 && (
              <div style={{ fontSize: 13, color: '#8b949e', textAlign: 'center', padding: 24, lineHeight: 1.6 }}>
            ...
            {conversation.map((msg, i) => (
              <div key={i} style={{
                ...
                padding: '8px 12px',
                borderRadius: 6,
                backgroundColor: msg.role === 'user' ? '#ddf4ff' : '#fff',
                border: '1px solid #d0d7de',
                fontSize: 13, color: '#0d1117', lineHeight: 1.5,
              }}>
                <div style={{ fontSize: 11, fontWeight: 600, color: '#656d76', marginBottom: 3 }}>
            ...
            {summary && (
              <div>
                <div style={{
                  ...
                  border: '1px solid #d0d7de', marginBottom: 10,
                }}>
                  <div style={{ fontSize: 11, fontWeight: 600, color: '#656d76', marginBottom: 3 }}>
                    Summary
                  </div>
                  <div style={{ fontSize: 13, color: '#0d1117', lineHeight: 1.6 }}>
                    {summary.summary}
                  </div>
                </div>
                ...
                {summary.keyPoints?.length > 0 && (
                  <div style={{ marginBottom: 10 }}>
                    <div style={{ fontSize: 11, fontWeight: 600, color: '#656d76', marginBottom: 4 }}>Key Points</div>
                    {summary.keyPoints.map((kp, i) => (
                      <div key={i} style={{
                        display: 'flex', alignItems: 'flex-start', gap: 6,
                        padding: '6px 10px', backgroundColor: '#fff',
                        borderRadius: 6, border: '1px solid #d0d7de',
                        marginBottom: 4, fontSize: 12, color: '#24292f',
                      }}>
                        <svg width="10" height="10" viewBox="0 0 16 16" fill="#0969da" style={{ marginTop: 2, flexShrink: 0 }}>
                ...
                {summary.tasks?.length > 0 && (
                  <div style={{ marginBottom: 10 }}>
                    <div style={{ fontSize: 11, fontWeight: 600, color: '#656d76', marginBottom: 4 }}>Action Items</div>
                    {summary.tasks.map((task, i) => (
                      <div key={i} style={{
                        ...
                        <svg width="12" height="12" viewBox="0 0 16 16" fill="#1a7f37" style={{ marginTop: 2, flexShrink: 0 }}>
                ...
                {summary.decisions?.length > 0 && (
                  <div style={{ marginBottom: 10 }}>
                    <div style={{ fontSize: 11, fontWeight: 600, color: '#656d76', marginBottom: 4 }}>Decisions</div>
                    {summary.decisions.map((dec, i) => (
                      <div key={i} style={{
                        ...
                        <svg width="12" height="12" viewBox="0 0 16 16" fill="#8250df" style={{ marginTop: 2, flexShrink: 0 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: '1px solid #d0d7de', backgroundColor: '#fff',
                    color: '#24292f', fontSize: 12, cursor: 'pointer',
      ...
      {tab === 'chat' && (
        <div style={{ padding: '8px 12px', borderTop: '1px solid #d0d7de' }}>
          <div style={{ display: 'flex', gap: 6 }}>
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: loading || !query.trim() ? '#d0d7de' : '#0969da',
